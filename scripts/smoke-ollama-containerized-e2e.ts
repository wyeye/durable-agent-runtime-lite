...
const scenarios = [
  {
    name: 'final',
    command: ['corepack', 'pnpm', 'smoke:ollama-runtime-final-e2e'],
  ...
  {
    name: 'readonly',
    command: ['corepack', 'pnpm', 'smoke:ollama-runtime-readonly-e2e'],
  ...
  {
    name: 'l3',
    command: ['corepack', 'pnpm', 'smoke:ollama-runtime-l3-e2e'],
