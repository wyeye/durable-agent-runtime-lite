  ...
  return (
    <Space direction="vertical" style={{ width: '100%' }}>
      ...
      <Form layout="vertical">
        ...
        <Checkbox checked={Boolean(value.side_effect)} disabled={readOnly} onChange={(event) => onChange({ ...value, side_effect: event.target.checked })}>{t('visualConfig.tool.sideEffect')}</Checkbox>
